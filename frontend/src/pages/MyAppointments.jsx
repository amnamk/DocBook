...
const MyAppointments = () => {
  ...
  return (
    <div>
      <p className="pb-3 mt-12 font-medium text-zinc-700 text-xl border-b">
        My appointments
      </p>
      <div className="">
              ...
              {!item.cancelled &&
                ...
                payment !== item._id && (
                  <button
                    ...
                    className="text-[#696969] sm:min-w-48 py-2 border rounded hover:bg-[#336ecc] hover:text-white transition-all duration-300"
                  >
                    Pay Online
                  </button>
                )}
